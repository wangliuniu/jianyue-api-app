...
public class UserServiceImplTest {
    ...
    public void getUserByMobile() {
        User user = userService.getUserByMobile("18912971703");
    ...
    public void signIn() {
        ...
        loginUser.setMobile("18912971703");
        String base64Pass = StringUtil.getBase64Encoder("1111");
